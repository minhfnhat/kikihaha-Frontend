    ...
    <div className={`py-16 sm:py-24`}>
      <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            Unlock the Full Potential of Your Worklife
          </h2>
          <p
          ...
          >
            Stay updated with the latest productivity tips, industry insights, and exclusive offers by subscribing to our newsletter. Enhance your work experience effortlessly!
          </p>
